...
[![Build Status](https://travis-ci.org/khulnasoft-lab/tls-tris.svg?branch=master)](https://travis-ci.org/khulnasoft-lab/tls-tris)
...
The script also transparently fetches the custom KhulnaSoft Go 1.10 compiler with the required backports.
